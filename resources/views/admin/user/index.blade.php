            ...
            <table class="table border ydatatable " id="userTable">
                ...
                <tbody>
                    @foreach ($user as $item)
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td><img src="{{ asset('image/'. $item->file_path)}}" class="img-thumbnail" width="75" /></td>
                            <td>{{ $item->name }}</td>
                            <td>{{ $item->email }}</td>
                            <td>
                                ...
                                <a href="{{url('display-image/' .$item->id)}}" class="btn btn-default modal-global"><i class="glyphicon glyphicon-eye-open"></i></a>
                            </td>
